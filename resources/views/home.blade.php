...
<div class="container">
        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('guardarPDF') }}" method="post" enctype="multipart/form-data" class="row justify-content-center">
                        @csrf
    ...
    <script>
        function miAlerta(evento) {
            alert("¡Asegúrese de seleccionar un documento de formato PDF!");
        }
    </script>
    @endsection
